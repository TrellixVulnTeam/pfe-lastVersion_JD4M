...
export class ProductsService {
  ...
  editEvent(id: string, event: Program): Observable < any > {
    return this.http.put(`${this.baseUrl}/put/${id}`, event);
  }

  ChangeStatus(id: string, productId: string): Observable < any > {
    return this.http.post(`${this.baseUrl}/changeStatus/${id}/pending/${productId}`, {
      responseType: 'text'
    });
  }
  ...
  deleteFeedback(id: string, value: any): Observable < any > {
    return this.http.post(`${this.baseUrl}/deletefeedback/${id}`, value);
  }
  editFeedback(id: string,index : number, feedback : Feedback): Observable < any > {
