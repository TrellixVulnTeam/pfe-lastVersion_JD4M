...
export interface StripeServiceInterface {
    ...
    confirmUsBankAccountPayment(clientSecret: string, data?: ConfirmUsBankAccountPaymentData): Observable<{
        paymentIntent?: PaymentIntent;
        error?: StripeError;
    }>;
    ...
    confirmKonbiniPayment(clientSecret: string, data?: ConfirmKonbiniPaymentData, options?: ConfirmKonbiniPaymentOptions): Observable<{
        paymentIntent?: PaymentIntent;
        error?: StripeError;
    }>;
    ...
    confirmSofortPayment(clientSecret: string, data?: ConfirmSofortPaymentData, options?: ConfirmSofortPaymentOptions): Observable<{
        paymentIntent?: PaymentIntent;
        error?: StripeError;
    }>;
    ...
    confirmUsBankAccountSetup(clientSecret: string, data?: ConfirmUsBankAccountSetupData): Observable<{
        setupIntent?: SetupIntent;
        error?: StripeError;
    }>;
    ...
    confirmSofortSetup(clientSecret: string, data?: ConfirmSofortSetupData, options?: ConfirmSofortSetupOptions): Observable<{
        setupIntent?: SetupIntent;
        error?: StripeError;
    }>;
